...
class ContentRowProduct extends Component {
    ...
    componentDidMount(){
        ...
        let promises = [
          fetch("http://localhost:3001/api/v1/productos").then(result => result.json()),
          fetch("http://localhost:3001/api/v1/users").then(result => result.json()),
          fetch("http://localhost:3001/api/v1/categories").then(result => result.json()),
          fetch("http://localhost:3001/api/v1/brands").then(result => result.json())
        ];
